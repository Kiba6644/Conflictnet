...
Outputs:
  - conflict_types: (B, 3) sigmoid probabilities — [sarcasm, suppression, deception]
  - severity:       (B, 1) regression in [0, 1] — conflict intensity
  - conflict_flag:  (B,) — binary conflict indicator (any type present)
...
class ConflictClassifier(nn.Module):
    ...
    Args:
        ...
        n_types: Number of conflict subtypes (default 3).
